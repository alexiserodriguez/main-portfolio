...
export function LinkedIn() {
  return (
    <svg
      className="fill-white dark:fill-blue duration-300"
...
export function Tableau() {
  return (
    ...
    >
      ...
      >
        <g transform="scale(5.12,5.12)">
          <path d="M23.5,0v4.5h-4v2h4v4.5h2v-4.5h4v-2h-4v-4.5zM11,5v6h-6v2h6v6h2v-6h6v-2h-6v-6zM36,5v6h-6v2h6v6h2v-6h6v-2h-6v-6zM23,16v7h-7v3h7v7h3v-7h7v-3h-7v-7zM5,19v4.5h-4v2h4v4.5h2v-4.5h4v-2h-4v-4.5zM43,19v4.5h-4v2h4v4.5h2v-4.5h4v-2h-4v-4.5zM11,29v6h-6v2h6v6h2v-6h6v-2h-6v-6zM36,29v6h-6v2h6v6h2v-6h6v-2h-6v-6zM23.5,38v4.5h-4v2h4v4.5h2v-4.5h4v-2h-4v-4.5z"></path>
        </g>
      </g>
    </svg>
  );
...
export function Icon({ logo, children, link }) {
  return <a href={link}>{children}</a>;
}
function SocialIcons() {
  return (
    <div className="flex row-auto justify-start gap-2 py-3">
      <Icon link="https://www.linkedin.com/in/alexiserodriguez">
        <LinkedIn />
      </Icon>

      <Icon link="https://www.github.com/alexiserodriguez">
        <Github />
      </Icon>
      <Icon link="https://public.tableau.com/app/profile/alexiserodriguez">
        <Tableau />
      </Icon>
    </div>
  );
